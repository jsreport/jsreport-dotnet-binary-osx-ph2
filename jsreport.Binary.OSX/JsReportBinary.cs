...
namespace jsreport.Binary.OSX.Ph2
{
    public class JsReportBinary
    {
        ...
        public static IReportingBinary GetBinary()
        {
            ...
            return new ReportingBinary("osx-ph2" + assembly.GetName().Version.ToString(),
                () =>
                {
                    var zip = new ZipArchive(assembly.GetManifestResourceStream("jsreport.Binary.OSX.Ph2.jsreport.zip"));
